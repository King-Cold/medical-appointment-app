    ...
    <div class="mb-4">
        <nav class="flex text-sm text-gray-500" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li class="text-gray-900 font-semibold"><i class="fa-solid fa-chevron-right mx-2 text-xs text-gray-400"></i> Atender</li>
            </ol>
        </nav>
    </div>
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                <div class="relative bg-white rounded-xl shadow-2xl dark:bg-gray-800">
                    <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                        ...
                        <button wire:click="closeMedicalSummary" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                            </svg>
                        </button>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="text-base font-bold text-gray-900 dark:text-white">{{ $appointment->patient->bloodType->name ?? 'No registrado' }}</p>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-gray-500">Alergias:</p>
                                <p class="text-base font-bold text-gray-900 dark:text-white">{{ $appointment->patient->allergies ?: 'No registradas' }}</p>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-gray-500">Enfermedades crónicas:</p>
                                <p class="text-base font-bold text-gray-900 dark:text-white">{{ $appointment->patient->chronic_conditions ?: 'No registradas' }}</p>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-gray-500">Antecedentes quirúrgicos:</p>
                                <p class="text-base font-bold text-gray-900 dark:text-white">{{ $appointment->patient->surgical_history ?: 'No registrados' }}</p>
                            </div>
                        </div>
                        <div class="flex justify-end pt-4 border-t border-gray-100 dark:border-gray-700">
                            <a href="{{ route('admin.patients.edit', $appointment->patient->id) }}" class="text-blue-600 font-semibold hover:underline">
